...
```{r, echo = FALSE, fig.width=9, fig.height=8, results="asis", linewidth=90}
    ...
    #compare_files(path_calibration_vsoil, path_calibration_espas, epsilon, "\t")
...
```{r, echo = FALSE, fig.width=9, fig.height=8, results="asis", linewidth=90}
    ...
    #compare_files(path_matrix_potential_vsoil, path_matrix_potential_espas, epsilon, ";")
...
```{r, echo = FALSE, fig.width=9, fig.height=8, results="asis", linewidth=90}
    ...
    #compare_files_bis(path_observ_value_vsoil, path_observ_value_espas, epsilon, ";")
